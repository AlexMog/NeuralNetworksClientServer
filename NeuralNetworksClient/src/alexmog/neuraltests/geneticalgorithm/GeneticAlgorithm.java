package alexmog.neuraltests.geneticalgorithm;
...
import alexmog.neuraltests.geneticalgorithm.entities.GeneticEntity;
...
public class GeneticAlgorithm {
    ...
    public GeneticAlgorithm(float crossOverChance, float mutationChance) {
        mCrossOverChance = crossOverChance;
        mElitismChance = 100 - crossOverChance;
